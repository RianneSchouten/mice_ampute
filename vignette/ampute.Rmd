...
Use the help function to read `ampute`'s [documentation](https://www.rdocumentation.org/packages/mice/versions/3.9.0/topics/ampute). The function is available in multiple imputation package [**mice**](https://github.com/stefvanbuuren/mice). 
